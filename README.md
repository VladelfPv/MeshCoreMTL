...
- Сообщайте об ошибках и запрашивайте новые функции на странице [Issues в GitHub](https://github.com/ripplebiz/MeshCore/issues).
- Найдите дополнительные руководства и компоненты на [сайте](https://buymeacoffee.com/ripplebiz).
- Присоединяйтесь к сообществу [MeshCore в Discord](https://discord.gg/BMwCtwHj5V), чтобы пообщаться с разработчиками и получить помощь от сообщества.
